...
const groupProgramsByProvince = (programs: ProgramCard[]): ProvinceStack[] => {
  ...
  const provinceDescriptions = {
    ...
    "British Columbia": "Pacific coast province with tech and natural resources",
    ...
    "Newfoundland & Labrador": "Atlantic province with natural resource opportunities",
  ...
  return Array.from(provinceMap.entries()).map(([name, programs]) => ({
    ...
    name,
    programs,
    color: provinceColors[name as keyof typeof provinceColors] || "rgb(107, 114, 128)",
    description: provinceDescriptions[name as keyof typeof provinceDescriptions] || "",
            ...
            <div className="space-y-8">
              <div>
                ...
                <h2 className="text-4xl font-bold tracking-tight mb-6">
                  Explore <span className="text-blue-400">Canada's provinces</span> and their programs
                </h2>
                <p className="text-white/80 leading-relaxed">
                  Each Canadian province and territory offers unique immigration programs 
                  tailored to their economic needs. Click on any province to explore 
                  their specific programs and requirements.
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white/5 border border-white/10 rounded-lg p-4">
                  ...
                  <div className="text-sm text-white/70">Provinces & Territories</div>
                </div>
                <div className="bg-white/5 border border-white/10 rounded-lg p-4">
