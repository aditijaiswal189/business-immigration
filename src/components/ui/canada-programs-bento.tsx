...
type Props = {
  title?: string;
  items?: ProgramCard[];
  phoneHref?: string; // e.g. "tel:+1-555-555-5555"
};

/* -------------------- Canada programs (sample, edit freely) -------------------- */
const DEFAULT_ITEMS: ProgramCard[] = [
  {
    id: "suv",
    title: "Start-Up Visa (SUV)",
    href: "/immigrate-canada/start-up-visa",
    image:
      "https://images.pexels.com/photos/3182773/pexels-photo-3182773.jpeg?auto=compress&cs=tinysrgb&w=1920&q=80",
    badge: "Popular",
  ...
  },
  {
    ...
    href: "/immigrate-canada/alberta-rural-renewal-stream",
    image:
      "https://images.pexels.com/photos/414459/pexels-photo-414459.jpeg?auto=compress&cs=tinysrgb&w=1920&q=80",
    budgetText: "Employer-driven (varies)",
    prText: "Provincial processing + federal PR",
  },
  {
    id: "oinp-entrepreneur",
    title: "Ontario Entrepreneur Stream (OINP)",
    href: "/immigrate-canada/oinp-entrepreneur",
    image:
      "https://images.pexels.com/photos/460672/pexels-photo-460672.jpeg?auto=compress&cs=tinysrgb&w=1920&q=80",
  ...
  },
  {
    id: "bc-pnp-tech",
    title: "BC PNP Tech",
    href: "/immigrate-canada/bc-pnp-tech",
    image:
      "https://images.pexels.com/photos/355747/pexels-photo-355747.jpeg?auto=compress&cs=tinysrgb&w=1920&q=80",
    budgetText: "Job offer required",
    prText: "Priority processing (provincial) + PR",
  },
  {
    id: "atlantic-immigration-program",
    title: "Atlantic Immigration Program (AIP)",
    href: "/immigrate-canada/atlantic-immigration-program",
    image:
      "https://images.pexels.com/photos/356830/pexels-photo-356830.jpeg?auto=compress&cs=tinysrgb&w=1920&q=80",
    budgetText: "Employer-backed (varies)",
    prText: "Employer endorsement → PR",
  },
  {
    id: "sask-entrepreneur",
    title: "Saskatchewan Entrepreneur",
    href: "/immigrate-canada/saskatchewan-entrepreneur",
    image:
      "https://images.pexels.com/photos/573552/pexels-photo-573552.jpeg?auto=compress&cs=tinysrgb&w=1920&q=80",
    budgetText: "Investment + net-worth criteria",
    prText: "Work permit → nomination → PR",
  },
];
...
/* -------------------- Card -------------------- */
function ProgramBentoCard({ item }: { item: ProgramCard }) {
  return (
    <div
      className={cn(
    ...
    >
      ...
      <div className="hidden items-center justify-between px-6 py-5 sm:flex">
        ...
        <div>
          <p className="text-[0.95rem] text-neutral-500">Pathway / timeline</p>
          <p
            className="text-[1.125rem] font-semibold leading-[1.33]"
            style={{ color: "var(--accent)" }}
          >
...
/* -------------------- Main section -------------------- */
export function CanadaProgramsBento({
  title = "Canada",
  items = DEFAULT_ITEMS,
      ...
      <div className="relative z-10 mx-auto flex max-w-8xl gap-10 px-10 py-14 sm:items-start sm:space-x-[6.19rem] xsm:flex-col">
        ...
        <div className="flex flex-1 flex-col items-center pb-[9.5rem] xsm:mt-4 xsm:w-full">
          <div className="grid w-full grid-cols-2 gap-6 pb-24 xsm:grid-cols-1 xsm:pb-0">
            {filtered.map((item) => (
              <ProgramBentoCard key={item.id} item={item} />
            ))}
          </div>
        </div>
      </div>
